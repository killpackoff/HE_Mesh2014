 ...
 */
public class HE_Mesh extends HE_MeshStructure implements WB_HasData, WB_HasColor, WB_Mesh {
     ...
     * Constructor.
     *
     * @param creator HE_Creator that generates this mesh
     */
     ...
     * Modify the mesh.
     *
     * @param modifier HE_Modifier to apply
     * @return self
     */
     ...
     *
     * @param subdividor HE_Subdividor to apply
     * @param selection  HE_Selection initial selection
     ...
     *
     * @param target HE_Mesh to be duplicated
     */
     ...
     *
     * @param scaleFactorx x-coordinate of scale factor
     * @param scaleFactory y-coordinate of scale factor
     * @param scaleFactorz z-coordinate of scale factor
     * @param c            center
     * @return self
     */
     ...
     * Pair halfedges.
     *
     * @param unpairedHalfedges the unpaired halfedges
     */
     ...
     * Divide edge.
     *
     * @param key key of edge to divide
     * @param n   number of parts
     */
     ...
     * @param isConvex do fast check, convex meshes only
     * @return true or false
     */
